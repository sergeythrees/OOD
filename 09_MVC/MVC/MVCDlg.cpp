...
// MVCDlg.cpp : implementation file
//
...
CMVCDlg::CMVCDlg(CWnd* pParent /*=NULL*/)
	: CDialogEx(IDD_MVC_DIALOG, pParent)
{
...
BEGIN_MESSAGE_MAP(CMVCDlg, CDialogEx)
	...
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_NOTIFY(NM_CUSTOMDRAW, IDC_SLIDER1, &CMVCDlg::OnNMCustomdrawSlider1)
END_MESSAGE_MAP()


// CMVCDlg message handlers
...
void CMVCDlg::OnNMCustomdrawSlider1(NMHDR *pNMHDR, LRESULT *pResult)
{
